                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-calendar-o"></i> Tabulador de vacaciones</h3>
                                <span class="pull-right clickable"><i class="fa fa-chevron-up"></i></span>
                            </div>
                            <div class="panel-body" style="display: block; max-height: 510px; overflow-y: auto;">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-condensed table-hover">
                                        <caption style="margin-top: 0;">MIS VACACIONES</caption>
                                        <thead>
                                        <tr>
                                        ...
                                        <tbody id="vacsconusr">
                                        <?php echo printmyvacs($_SESSION['idloguser'], $_SESSION['periodo'], FALSE); ?>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
